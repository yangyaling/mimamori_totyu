...
+(void)noticeInfoWithParam:(MNoticeInfoParam *)param success:(void (^)(NSArray *array))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL:@"http://mimamori.azurewebsites.net/zwgetnoticeinfo.php" params:param.mj_keyValues success:^(id json) {
        if (success) {
            // 字典数组转模型数组
...
+(void)noticeDatesWithParam:(MNoticeDateParam *)param success:(void (^)(NSArray *array))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL:@"http://mimamori.azurewebsites.net/zwgetnoticedatelist.php"params:param.mj_keyValues success:^(id json) {
        if (success) {
...
+(void)noticeInfoUpdateWithParam:(MNoticeInfoUpdateParam *)param success:(void (^)(NSString *code))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL:@"http://mimamori.azurewebsites.net/zwupdatenoticeinfo.php"params:param.mj_keyValues success:^(id json) {
        if (success) {

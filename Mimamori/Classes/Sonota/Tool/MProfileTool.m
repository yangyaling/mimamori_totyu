...
+(void)profileInfoWithParam:(MProfileInfoParam *)param success:(void (^)(NSArray *))success failure:(void (^)(NSError *))failure{
    [MHttpTool postWithURL:@"http://mimamori.azurewebsites.net/zwgetcustinfo.php" params:param.mj_keyValues success:^(id json) {
        if (success) {
...
+(void)profileInfoUpdateWithParam:(MProfileInfoUpdateParam *)param success:(void (^)(NSString *code))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL: @"http://mimamori.azurewebsites.net/zwupdatecustinfo.php" params:param.mj_keyValues success:^(id json) {
        if (success) {

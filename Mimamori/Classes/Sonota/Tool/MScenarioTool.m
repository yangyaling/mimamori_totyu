...
+(void)scenarioListWithParam:(MScenarioListParam *)param success:(void (^)(NSArray *array))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL:@"http://mimamori.azurewebsites.net/zwgetscenariolist.php" params:param.mj_keyValues success:^(id json) {
        if (success) {
...
+(void)scenarioDeleteWithParam:(MScenarioDeleteParam *)param success:(void (^)(NSString *code))success failure:(void (^)(NSError *error))failure{
    [MHttpTool postWithURL: @"http://mimamori.azurewebsites.net/zwdeletescenarioinfo.php" params:param.mj_keyValues success:^(id json) {
        if (success) {

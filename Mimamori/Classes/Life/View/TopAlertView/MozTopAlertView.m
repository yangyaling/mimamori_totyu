...
#define FlatBlue hsb(213, 55, 100)
...
- (void)setType:(MozAlertType)type text:(NSString*)text doText:(NSString*)doText{
    ...
    [self setFrame:CGRectMake((NITScreenW - width) * 0.5, 15, width, 50)];
    ...
    leftIcon.font = [UIFont fontAwesomeFontOfSize:33];
//    leftIcon.numberOfLines = 0;
